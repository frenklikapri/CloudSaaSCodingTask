...
using CloudSaaSCodingTask.Dtos.PaginatedTable;
using CloudSaaSCodingTask.Store.PaginatedTable;
using Fluxor;
...
namespace CloudSaaSCodingTask.Web.Components
{
    partial class PaginatedTable<TItem> : ComponentBase
    {
        ...
        [Parameter] public Func<PaginationParameters, Task<PaginatedResult<TItem>>> GetItemsAsListAsync { get; set; }
        ...
        async Task LoadItems(bool lastPage = false)
        {
            try
            {
                Loading = true;
